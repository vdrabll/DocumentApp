...
Что бы протестировать приложение заранее запустите докер, далее запустите проект и прейдите по адресу (http://localhost:8080/) что бы попасть на главный экран.
